...
PRODUCT_COPY_FILES += \
    ...
    $(CONFIG_PATH)/media_codecs_vendor_cobalt.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_cobalt.xml \
    ...
    $(CONFIG_PATH)/media_profiles_cobalt.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_cobalt.xml \
    $(CONFIG_PATH)/mediacodec-seccomp.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy \
    $(CONFIG_PATH)/mediaextractor-seccomp.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediaextractor.policy \
